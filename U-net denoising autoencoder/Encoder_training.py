...
def main():
    ...
    train_x_before1 = np.load(args.data_root1 + '/ct_total.npy')
    train_y_before1 = np.load(args.data_root1 + '/stage_total.npy')
    train_x_before2 = np.load(args.data_root2 + '/ct_total.npy')
    train_y_before2 = np.load(args.data_root2 + '/stage_total.npy')
    test_x_before1 = np.load(args.data_root3 + '/ct_total.npy')
    test_y_before1 = np.load(args.data_root3 + '/stage_total.npy')
    test_x_before2 = np.load(args.data_root4 + '/ct_total.npy')
    test_y_before2 = np.load(args.data_root4 + '/stage_total.npy')
